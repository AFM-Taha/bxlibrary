...
function AdminBooks() {
  ...
  const fetchBooks = async (page = 1, search = '') => {
    try {
      ...
      const response = await fetch(
        `/api/admin/books?page=${page}&limit=${booksPerPage}${searchParam}`,
        {
          credentials: 'include',
        },
      )
  ...
  const handleBulkUpload = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success(
          `Bulk upload completed! Created: ${result.results.created}, Updated: ${result.results.updated}`,
        )
  ...
  const handleTogglePublish = async (book) => {
    try {
      ...
      if (response.ok) {
        toast.success(
          `Book ${action === 'publish' ? 'published' : 'unpublished'} successfully`,
        )
        fetchBooks(currentPage, searchTerm)
      } else {
        const data = await response.json()
      ...
      <div className='min-h-screen bg-secondary-50 dark:bg-secondary-950'>
            ...
            <div className='flex justify-between items-center py-6'>
              ...
              <div className='flex items-center space-x-4'>
                ...
                <button
                  ...
                  className='bg-success-600 hover:bg-success-700 text-white px-4 py-2 rounded-md text-sm font-medium'
                >
                  Bulk Upload
                </button>
                <button
            ...
            <div className='max-w-md'>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className='block w-full pl-10 pr-3 py-2 border border-secondary-300 dark:border-secondary-600 rounded-md leading-5 bg-white dark:bg-secondary-700 text-secondary-900 dark:text-white placeholder-secondary-500 dark:placeholder-secondary-400 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500'
                />
              </div>
            </div>
          </div>

          <div className='bg-white dark:bg-secondary-800 shadow rounded-lg overflow-hidden border border-secondary-200 dark:border-secondary-700'>
                          ...
                          {book.categories && book.categories.length > 0 ? (
                            book.categories.map((category, index) => (
                              <span
                                ...
                                className='inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-200'
                              >
                                {category.name}
                              </span>
                            ))
                          ) : (
                            <span className='inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-secondary-100 text-secondary-800 dark:bg-secondary-700 dark:text-secondary-200'>
                              Uncategorized
                            </span>
                          )}
                        </div>
                ...
                <div className='hidden sm:flex-1 sm:flex sm:items-center sm:justify-between'>
                  <div>
                    <p className='text-sm text-secondary-700 dark:text-secondary-300'>
                      ...
                      of <span className='font-medium'>{totalBooks}</span>{' '}
                      results
                    </p>
                  </div>
                  <div>
                            ...
                            <button
                              ...
                              className={`relative inline-flex items-center px-4 py-2 border text-sm font-medium ${
                                pageNum === currentPage
                                  ...
                                  : 'bg-white dark:bg-secondary-700 border-secondary-300 dark:border-secondary-600 text-secondary-500 dark:text-secondary-400 hover:bg-secondary-50 dark:hover:bg-secondary-600'
                              }`}
                            >
                              {pageNum}
                            </button>
        ...
        {(showCreateModal || editingBook) && (
          <div className='fixed inset-0 bg-secondary-600 bg-opacity-50 overflow-y-auto h-full w-full z-50'>
            <div className='relative top-10 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white dark:bg-secondary-800 border-secondary-200 dark:border-secondary-700'>
              <div className='mt-3'>
                ...
                >
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div className='mb-4'>
                      ...
                      <input
                        ...
                        className='w-full px-3 py-2 border border-secondary-300 dark:border-secondary-600 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-secondary-700 text-secondary-900 dark:text-white'
                        required
                      />
                    </div>
                    <div className='mb-4'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div className='mb-4'>
                      ...
                      <div className='space-y-2 max-h-40 overflow-y-auto border border-secondary-300 dark:border-secondary-600 rounded-md p-2 bg-white dark:bg-secondary-700'>
                        {categories.map((category) => (
                          <label
                            key={category._id}
                            className='flex items-center space-x-2 cursor-pointer hover:bg-secondary-50 dark:hover:bg-secondary-600 p-1 rounded'
                          >
                            <input
                              type='checkbox'
                    ...
                    <div className='mb-4'>
                      ...
                      {editingBook && editingBook.driveUrl && (
                        <div className='mb-2 p-2 bg-secondary-50 dark:bg-secondary-700 rounded border'>
                ...
                <div className='space-y-6'>
                    ...
                    <div className='border-2 border-dashed border-secondary-300 dark:border-secondary-600 rounded-lg p-6'>
                      <div className='text-center'>
                        ...
                        <div className='mt-4'>
                          ...
                          >
                            <span className='mt-2 block text-sm font-medium text-secondary-900 dark:text-white'>
                              {bulkUploadFile
                                ? bulkUploadFile.name
                  ...
                  <div>
                    ...
                    <p className='text-xs text-secondary-500 dark:text-secondary-400 mb-2'>
                      Note: driveUrl is optional. Books can be created without
                      Google Drive links.
                    </p>
                    <pre className='bg-secondary-100 dark:bg-secondary-700 p-3 rounded text-xs overflow-x-auto'>
                      {`[
  {
    "title": "Book Title",
    "author": "Author Name",
    ...
    "isPublished": false
                            ...
                            <div className='mt-1 max-h-32 overflow-y-auto'>
                              ...
                              {bulkUploadResults.errors.length > 5 && (
                                <p className='text-xs text-secondary-500 dark:text-secondary-400'>
                                  ... and {bulkUploadResults.errors.length - 5}{' '}
                                  more errors
                                </p>
                              )}
                            </div>
                  ...
                  <div className='flex justify-end space-x-3 pt-4 border-t border-secondary-200 dark:border-secondary-600'>
                    ...
                    <button
                      ...
                      className='px-4 py-2 text-sm font-medium text-white bg-success-600 hover:bg-success-700 disabled:bg-secondary-400 disabled:cursor-not-allowed rounded-md'
                    >
