...
function AdminCategories() {
  ...
  const fetchCategories = async () => {
    try {
      ...
      const response = await fetch(
        `/api/admin/categories?t=${Date.now()}&includeDeleted=${includeDeleted}`,
        {
          credentials: 'include',
        },
      )
  ...
  const handleBulkImport = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success(
          `Bulk import completed: ${data.results.created} created, ${data.results.updated} updated`,
        )
    ...
    <ProtectedRoute requireAdmin={true}>
      <div className='min-h-screen bg-secondary-50 dark:bg-secondary-900'>
            ...
            {categories.map((category) => (
              <div
                ...
                className={`rounded-lg shadow-md overflow-hidden ${
                  showDeleted
                    ? 'bg-error-50 dark:bg-error-900/20 border-2 border-error-200 dark:border-error-800'
              ...
              >
                ...
                ></div>
                {showDeleted && (
                  <div className='bg-error-100 dark:bg-error-900/40 px-4 py-2 border-b border-error-200 dark:border-error-800'>
                    <span className='text-error-700 dark:text-error-300 text-xs font-medium'>
                      🗑️ DELETED -{' '}
                      {category.deletedAt
        ...
        {(showCreateModal || editingCategory) && (
          <div className='fixed inset-0 bg-secondary-900/50 backdrop-blur-sm overflow-y-auto h-full w-full z-50'>
            <div className='relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white dark:bg-secondary-800 border-secondary-200 dark:border-secondary-700'>
              <div className='mt-3'>
                ...
                >
                  ...
                  <div className='mb-6'>
                    ...
                    <div className='flex items-center space-x-3'>
                      <input
                        ...
                        className='h-10 w-16 border border-secondary-300 dark:border-secondary-600 rounded cursor-pointer bg-white dark:bg-secondary-700'
                      />
                      <input
                        type='text'
                        value={formData.color}
                        ...
                        className='flex-1 px-3 py-2 border border-secondary-300 dark:border-secondary-600 rounded-md bg-white dark:bg-secondary-700 text-secondary-900 dark:text-white focus:outline-none focus:ring-primary-500 focus:border-primary-500'
                        placeholder='#3B82F6'
                      />
                    </div>
                  </div>
                  ...
                  <div className='flex justify-end space-x-3'>
                    <button
                      type='button'
                      onClick={closeModal}
                      className='px-4 py-2 text-sm font-medium text-secondary-700 dark:text-secondary-300 bg-secondary-100 dark:bg-secondary-700 hover:bg-secondary-200 dark:hover:bg-secondary-600 rounded-md'
                    >
                      Cancel
                    </button>
                    <button
              ...
              <div className='p-6'>
                ...
                <div className='mb-4'>
                  <p className='text-sm text-secondary-600 dark:text-secondary-400 mb-3'>
                    Upload a JSON file with category data. Categories will be
                    matched by name (case-insensitive). Existing categories will
                    be updated, new ones will be created.
                  </p>
                  ...
                  <div className='bg-secondary-50 dark:bg-secondary-700 p-3 rounded-md'>
                    <p className='text-xs text-secondary-600 dark:text-secondary-400 font-medium mb-2'>
  ...
  },
  {
    ...
    "color": "#33FF57"
                ...
                {bulkImportResults && (
                  <div className='mb-4 p-3 bg-primary-50 dark:bg-primary-900/20 rounded-md'>
                ...
                <div className='flex justify-end space-x-3'>
                  <button
                    onClick={resetBulkImportModal}
                    className='px-4 py-2 text-secondary-700 dark:text-secondary-300 bg-secondary-100 dark:bg-secondary-700 hover:bg-secondary-200 dark:hover:bg-secondary-600 rounded-md text-sm font-medium'
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className='px-4 py-2 bg-success-600 hover:bg-success-700 disabled:bg-secondary-400 text-white rounded-md text-sm font-medium'
                  >
