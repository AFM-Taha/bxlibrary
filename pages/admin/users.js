...
function AdminUsers() {
  ...
  const openEditModal = (userToEdit) => {
    ...
    setFormData({
      ...
      expiryDate: userToEdit.expiryDate
        ? new Date(userToEdit.expiryDate).toISOString().split('T')[0]
        : '',
    })
  }
      ...
      <div className='min-h-screen bg-secondary-50 dark:bg-secondary-950'>
        ...
        {(showCreateModal || editingUser) && (
          <div className='fixed inset-0 bg-secondary-900/50 backdrop-blur-sm overflow-y-auto h-full w-full z-50'>
            <div className='relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-secondary-800 border-secondary-200 dark:border-secondary-700'>
              <div className='mt-3'>
