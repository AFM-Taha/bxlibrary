...
function AdminPricing() {
  ...
  const [newFeature, setNewFeature] = useState({ name: '', included: true, limit: '' });
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Loading pricing plans...</p>
        </div>
      </div>
    );
  }
              ...
              <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    Showing <span className="font-medium">{(currentPage - 1) * plansPerPage + 1}</span> to{' '}
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex gap-2 mb-3">
                      ...
                      <input
                        ...
                        className="w-24 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                        placeholder="Limit"
                      />
                  ...
                  <div className="mb-6 space-y-3">
                    <label className="flex items-center">
                      <input
                        ...
                        className="rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50"
                      />
                      <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Mark as popular plan</span>
                    </label>
                    <label className="flex items-center">
                      <input
                        type="checkbox"
                        ...
                        className="rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50"
                      />
                      <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Active plan</span>
                    </label>
                  </div>
