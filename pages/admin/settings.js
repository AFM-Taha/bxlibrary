            ...
            <div className='flex-1'>
              <form onSubmit={handleSaveSettings}>
                <div className='bg-white dark:bg-secondary-800 shadow rounded-lg'>
                      ...
                      <div className='space-y-6'>
                        <div>
                          ...
                          <input
                            ...
                            className='w-full px-3 py-2 border border-secondary-300 dark:border-secondary-600 rounded-md bg-white dark:bg-secondary-800 text-secondary-900 dark:text-white focus:outline-none focus:ring-primary-500 focus:border-primary-500'
                            ...
                            <div className='ml-3'>
                              ...
                              <div className='mt-2 text-sm text-warning-700 dark:text-warning-300'>
                                <p>
                                  ...
                                  environment variables and cannot be changed
                                  from the admin panel for security reasons.
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div>
                          <label className='flex items-center'>
                            <input
                              ...
                              className='rounded border-secondary-300 dark:border-secondary-600 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50'
                            />
                            <span className='ml-2 text-sm text-secondary-700 dark:text-secondary-300'>
                  ...
                  <div className='px-6 py-4 bg-secondary-50 dark:bg-secondary-700 border-t border-secondary-200 dark:border-secondary-700 flex justify-end'>
                    <button
                      type='submit'
                      disabled={saving}
